...
import logo from "../../assets/menu/re.png";

const Footer = () => {
  return (
    <footer className="flex justify-between flex-col md:flex-row bg-orange/50 p-10 bg-base-200 text-base-content">
      <aside className="flex items-center flex-col text-center mb-8 md:-mb-0">
        <img src={logo} alt="" className="max-h-[180px] max-w-[180px]" />
